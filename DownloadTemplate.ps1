...
# Template creates a Windows image and outputs the customized image to a Managed Image
# Set the template file path and the template file name
$Win10Url = "https://raw.githubusercontent.com/singhsupriya2819/ImageBuilderScript/main/BaseFunction.ps1?token=AOFPA6BBBZVNUCTLESOO3YTBSKIWY'n"
...
New-AzVM -ResourceGroupName $imageResourceGroup -Image $ArtifactId -Name myWinVM01 -Credential $Cred -size Standard_Ds1_v2
